...
const (
	NotificationsService_Send_FullMethodName = "/paperboard.notifications.v1.NotificationsService/Send"
)
...
var NotificationsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "paperboard.notifications.v1.NotificationsService",
