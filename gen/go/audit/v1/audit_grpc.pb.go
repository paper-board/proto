...
const (
	AuditService_Emit_FullMethodName     = "/paperboard.audit.v1.AuditService/Emit"
	AuditService_Query_FullMethodName    = "/paperboard.audit.v1.AuditService/Query"
	AuditService_GetEvent_FullMethodName = "/paperboard.audit.v1.AuditService/GetEvent"
)
...
func (c *auditServiceClient) GetEvent(ctx context.Context, in *GetEventRequest, opts ...grpc.CallOption) (*Event, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Event)
...
func (UnimplementedAuditServiceServer) GetEvent(context.Context, *GetEventRequest) (*Event, error) {
...
var AuditService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "paperboard.audit.v1.AuditService",
